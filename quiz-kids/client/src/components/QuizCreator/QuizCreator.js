    ...
    <section className={styles.section}>
              ...
              isQuestionDataSave
                ...
                : alert(
                    isLanguageEnglish
                      ...
                      : "Lưu các thay đổi của bạn cho câu hỏi trước"
                  )
            }}
      ...
      <div className={styles.options}>
        ...
        >
          ...
          <div className={styles["option-label"]}>
            <label>
              {isLanguageEnglish ? "Points per question" : "Điểm mỗi câu"}
            </label>
          </div>
          <input
            type="number"
          ...
          <div>
            ...
            >
              {isLanguageEnglish ? "Submit" : "Ghi nhận"}
            </button>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className={styles.option}>
            <div className={styles["option-label"]}>
              <img src={timer} alt="" />
              <label>{isLanguageEnglish ? "Time limit" : "Thời gian cho mỗi câu"}</label>
            </div>
            <select
              onChange={handleQuestionChange}
              name="answerTime"
            ...
            >
              <option defaultValue disabled>
                {isLanguageEnglish ? "Set time limit" : "Đặt thời gian cho mỗi câu"}
              </option>
              <option value={5}>
          ...
          <div className={styles.option}>
            <div className={styles["option-label"]}>
              ...
              <label>
                {isLanguageEnglish ? "Answer options" : "Lựa chọn câu trả lời"}
              </label>
            </div>
